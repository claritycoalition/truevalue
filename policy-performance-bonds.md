...
Not only are policy performance bonds giving an incentive for governments and businesses to achieve ambitious longer-term sustainability targets, they are an investment strategy that can be implemented immediately and follows the path to 10 billion people living well by 2050.
...
A number of benefits are created from a simple step of adding an interest-linked sustainability target — agreed between investor and investee — to a sovereign, municipal, or corporate bond contract.

#### 1. PPBs provide potentially reduced or zero interest rates for government and business if the sustainability target is met.
...
#### 4. PPBs work as a hedging tool for investment portfolios.
